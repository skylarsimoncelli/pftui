...
| **[docs/CYCLE-SIGNALS.md](docs/CYCLE-SIGNALS.md)** | The mechanical cycle-bottom signal suite — the deterministic N-of-7 confluence checklist (`analytics cycles bottom-signals`): what each of the 7 criteria measures, why confluence marks lows, the JSON shape, and how to backtest it. Read before touching `analytics/cycle_signals.rs` or any prose that itemizes cycle-bottom confirmations |
