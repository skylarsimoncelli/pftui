...
- Tests: 6 known-answer unit tests (recovery-cliff identities; risk-of-ruin = 0.2373 at μ=.001/σ=.02/B=.25 hand-derived; Triple-Penance T_DD=270.5d / MaxDD=27.06% / MaxTuW=1082d hand-derived; AR(1) variance-direction; μ≤0 flagged-not-silent; thin/constant guards); full `cargo test` + `cli_help_smoke` green; clippy clean. Live: BTC max-DD@95% 72% / TuW ~6.9y / ruin 58% vs gold 20% / ~5.3y / 15% at a 25% budget.
