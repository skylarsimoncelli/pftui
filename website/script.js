...
const scenes = [
    {
        lines: [
            ...
            { text: '│  ● Regime: Risk-off               75%   │', type: 'output', delay: 30 },
            { text: '└──────────────────────────────────────────┘', type: 'output', delay: 30 },
        ],
        hold: 3000,
    },
    {
        lines: [
            ...
            { text: '│  GC=F  bullish    142    2 bull layers   │', type: 'output', delay: 30 },
            { text: '│                          Conviction +4   │', type: 'output', delay: 30 },
            { text: '│                          War Esc at 85%  │', type: 'output', delay: 30 },
    ...
    },
    {
        lines: [
            ...
            { text: '│  GC=F  LOW:bear MED:bull HIGH:bull      │', type: 'output', delay: 30 },
            { text: '└──────────────────────────────────────────┘', type: 'output', delay: 30 },
        ],
        hold: 3000,
    },
    {
        lines: [
            ...
            { text: '  ✓ Regime         risk-off (0.75)        │', type: 'output', delay: 30 },
            ...
            { text: '  ✓ News           116 articles           │', type: 'output', delay: 30 },
    ...
    },
    {
        lines: [
            ...
            { text: '│                                         │', type: 'output', delay: 30 },
            { text: '│  NEXT WEEK                              │', type: 'output', delay: 30 },
    ...
    {
        lines: [
            { text: '$ pftui journal prediction stats --json', type: 'command', delay: 60 },
            { text: '', type: 'output', delay: 200 },
            ...
            { text: '    "low":    {"scored": 9,"hit_rate":44.4}', type: 'json', delay: 20 },
            { text: '  }', type: 'json', delay: 20 },
            { text: '}', type: 'json', delay: 20 },
        ],
        hold: 3000,
    ...
    {
        lines: [
            { text: '$ pftui data refresh && pftui analytics situation --json', type: 'command', delay: 60 },
            { text: '', type: 'output', delay: 200 },
            ...
            { text: '$ pftui journal conviction set GC=F --score 4 --notes "war hedge"', type: 'command', delay: 30 },
            { text: '✓ conviction logged: GC=F = +4', type: 'output', delay: 30 },
            { text: '$ pftui agent message send "Gold: all 4 layers bullish"', type: 'command', delay: 30 },
            { text: '✓ message queued for operator review', type: 'output', delay: 30 },
            { text: '$ pftui analytics alignment --symbol GC=F', type: 'command', delay: 30 },
            { text: 'GC=F  bull bull bull neutral  BULLISH 75%', type: 'output', delay: 30 },
            { text: 'BTC   bear bull bull neutral  MIXED   50%', type: 'output', delay: 30 },
        ],
        hold: 3200,
    },
];
