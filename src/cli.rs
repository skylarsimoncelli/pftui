...
pub enum ReportCommand {
    ...
    Chart {
        /// Chart name: stacked-bar, prob-bar, drift-bar, what-changed-strip, open-predictions-table, outlook-arrows, factor-exposure, conviction-grid, or mismatch-card
        chart_name: String,

        /// Render from a canonical DB query. stacked-bar accepts portfolio; prob-bar accepts a scenario name; drift-bar, outlook-arrows, and conviction-grid accept a symbol; conviction-grid also accepts all/views; open-predictions-table accepts pending/open or a limit. factor-exposure and mismatch-card are JSON-only.
