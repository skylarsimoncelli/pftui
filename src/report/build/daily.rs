...
pub struct BuildContext {
    ...
    /// analysts' actual narrative (e.g. a leading per-asset move and
    /// operator-readable action signal) rather than the generic regime
    /// fallback. None when no analyst notes / messages exist for the day.
